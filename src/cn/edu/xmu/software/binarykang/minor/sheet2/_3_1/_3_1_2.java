...
{
	private final static String TABLE_KEY_NUM = "3.1.2报纸阅读量 第一段文字中的报纸人均阅读量";
	private final static String TABLE_KEY_COUNTRY = "3.1.2报纸阅读量 第一段文字中的报纸人均阅读量——全国";
	private final static String TABLE_KEY_TYPE = "14-17岁不同群体的人均报纸阅读量";
	...
	protected void replace()
	{
		...
		tr("${_3_1_2_read_num_male_female}", 
				tableType.get(0).getRate()>tableType.get(1).getRate()?"高":"低");
